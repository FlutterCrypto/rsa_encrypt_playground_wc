...
class Rsa2048OaepSha256DecryptionRoute extends StatefulWidget {
  const Rsa2048OaepSha256DecryptionRoute({Key? key}) : super(key: key);

  final String title = 'OAEP Entschlüsselung';
...
class _MyFormPageState extends State<Rsa2048OaepSha256DecryptionRoute> {
  @override
  void initState() {
    super.initState();
  ...
  String txtDescription =
      'RSA 2048 Entschlüsselung mit OAEP SHA-256 Padding (maximal 214 Zeichen).'
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            if (algorithm != 'RSA-2048 OAEP SHA-256') {
                              outputController.text =
                                  'Fehler: es handelt sich nicht um einen Datensatz, der mit RSA-2048 OAEP SHA-256 verschlüsselt worden ist.';
                              return;
                            }
                            ...
                            try {
                              ...
                              RsaOaepPrivateKey rsaPrivateKey =
                                  await RsaOaepPrivateKey.importPkcs8Key(privateKeyBytes, Hash.sha256);
                              //printC('used private key:\n' + privateKeyPem);
                              decryptedtext =
                                  await rsaDecryptionFromBase64Wc(rsaPrivateKey, ciphertextBase64);
                            } catch (error) {
                              outputController.text =
  ...
  Future<String> rsaDecryptionFromBase64Wc(
      RsaOaepPrivateKey privateKey, String ciphertextBase64) async {
    try {
      var ciphertext = base64Decoding(ciphertextBase64);
      var decryptedtext = await privateKey.decryptBytes(ciphertext);
